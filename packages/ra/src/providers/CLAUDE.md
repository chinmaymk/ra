...
| `anthropic-agents-sdk.ts` | Anthropic Agent SDK — **one subprocess per provider instance** (persistent Query + pushable user-message channel), XML-tagged initial history, follow-up turns push plain user text. Subscription-based, no API key. |
